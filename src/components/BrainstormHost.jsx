          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 h-full pb-8 animate-fade-in">
            <div className="lg:col-span-3 flex flex-col gap-6">
              <div className="bg-white p-4 rounded-3xl shadow-2xl text-center">
                <div className="relative mx-auto w-40 h-40 overflow-hidden rounded-2xl shadow-[0_10px_30px_rgba(6,182,212,0.35)]">
                  <img
                    src={qrUrl}
                    alt={`Código QR para unirse con código ${sessionId}`}
                    className="w-full h-full object-contain"
                    loading="lazy"
                  />
                  <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-cyan-400/10 via-transparent to-orange-400/20" />
                </div>
