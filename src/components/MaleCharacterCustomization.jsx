...
const MALE_CHARACTERS = [
  { id: 1, name: "Médico Joven", type: "hair", variant: "brown-short" },
  { id: 2, name: "Médico Rubio", type: "hair", variant: "blonde-short" },
  { id: 3, name: "Médico Mayor", type: "hair", variant: "gray-short" },
  { id: 4, name: "Médico Profesional", type: "hair", variant: "blonde-medium" },
  { id: 5, name: "Especialista Pelirrojo", type: "hair", variant: "red-medium" },
  { id: 6, name: "Médico Calvo", type: "hair", variant: "bald" },
  { id: 7, name: "Doctor Barba", type: "beard", variant: "goatee" },
  { id: 8, name: "Cirujano Profesional", type: "hair", variant: "black-long" },
  { id: 9, name: "Médico Joven Moreno", type: "hair", variant: "black-medium" },
  { id: 10, name: "Profesional Moderno", type: "hair", variant: "brown-medium" },
  { id: 11, name: "Doctor con Carpeta", type: "accessory", variant: "clipboard-green" },
  { id: 12, name: "Médico Administrativo", type: "accessory", variant: "clipboard-yellow" },
  { id: 13, name: "Doctor Investigador", type: "accessory", variant: "clipboard-purple" },
