...
const BrainstormHost = ({ onBack }) => {
  ...
  const qrImage = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(joinUrl)}`;
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 h-full pb-8 animate-fade-in">
            <div className="lg:col-span-3 flex flex-col gap-6">
              <div className="bg-white p-4 rounded-3xl shadow-2xl text-center">
                <img src={qrImage} alt={`QR para unirse a la sesión ${sessionId}`} className="mx-auto w-36 h-36" />
