        ...
        {!isSessionActive ? (
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 h-full pb-8 animate-fade-in">
            <div className="lg:col-span-3 flex flex-col gap-6">
              <div className="bg-white p-4 rounded-3xl shadow-2xl text-center"><img src={`https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=${encodeURIComponent(joinUrl)}`} alt="Código QR de la sesión" className="mx-auto" /><p className="text-slate-900 font-black text-4xl mt-2 tracking-widest">{sessionId}</p><p className="text-slate-500 text-xs font-bold uppercase">Código de acceso</p></div>
